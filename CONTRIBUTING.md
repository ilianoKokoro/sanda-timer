...
All interactions within the Sanda Timer repository are governed by
our [Code of Conduct](CODE_OF_CONDUCT.md).
Please ensure all discussions, issues, and pull requests remain respectful and constructive.
...
1. Clone the repository
    ```bash
    git clone https://github.com/ilianokokoro/sanda-timer.git
    cd sanda-timer
    ```
